var app = new Vue({
    ...
    methods: {
        nextVideo() {
            ...
            axios.post(`/videos/${this.currentVideo}`,
                {
                    weight: parseInt(this.weight),
                    masc: parseInt(this.masc),
                    time: this.$refs.videotobeplayed.currentTime
                })
                .then((res) => {
                    dataj = res.data;
        ...
        startvideo() {
            if (this.videoready) {
                if (parseInt(this.$refs.videotobeplayed.currentTime) < 10) this.$refs.videotobeplayed.play();
            } else {
